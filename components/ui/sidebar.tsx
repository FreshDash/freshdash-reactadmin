...
import { generateSidebar } from '@/app/utils/permissions';
                ...
                {(handleClick, open) => {
                  return (
                    <>
                      <button
                        type="button"
                        className={`block text-left w-full text-gray-800 dark:text-gray-100 truncate transition ${segments.includes('dashboard') ? '' : 'hover:text-gray-900 dark:hover:text-white'}`}
                        onClick={(e) => {
                ...
                {(handleClick, open) => {
                  return (
                    <>
                      <button
                        type="button"
                        className={`block text-left w-full text-gray-800 dark:text-gray-100 truncate transition ${segments.includes('ecommerce') ? '' : 'hover:text-gray-900 dark:hover:text-white'}`}
                        onClick={(e) => {
                          expandOnly ? setSidebarExpanded(true) : handleClick()
                        }}
                      >
                ...
                {(handleClick, open) => {
                  return (
                    <>
                      <button
                        type="button"
                        className={`block text-left w-full text-gray-800 dark:text-gray-100 truncate transition ${segments.includes('community') ? '' : 'hover:text-gray-900 dark:hover:text-white'}`}
                        onClick={(e) => {
                          expandOnly ? setSidebarExpanded(true) : handleClick()
                        }}
                      >
                ...
                {(handleClick, open) => {
                  return (
                    <>
                      <button
                        type="button"
                        className={`block text-left w-full text-gray-800 dark:text-gray-100 truncate transition ${segments.includes('finance') ? '' : 'hover:text-gray-900 dark:hover:text-white'}`}
                        onClick={(e) => {
                          expandOnly ? setSidebarExpanded(true) : handleClick()
                        }}
                      >
                ...
                {(handleClick, open) => {
                  return (
                    <>
                      <button
                        type="button"
                        className={`block text-left w-full text-gray-800 dark:text-gray-100 truncate transition ${segments.includes('jobs') ? '' : 'hover:text-gray-900 dark:hover:text-white'}`}
                        onClick={(e) => {
                          expandOnly ? setSidebarExpanded(true) : handleClick()
                        }}
                      >
                ...
                {(handleClick, open) => {
                  return (
                    <>
                      <button
                        type="button"
                        className={`block text-left w-full text-gray-800 dark:text-gray-100 truncate transition ${segments.includes('tasks') ? '' : 'hover:text-gray-900 dark:hover:text-white'}`}
                        onClick={(e) => {
                          expandOnly ? setSidebarExpanded(true) : handleClick()
                        }}
                      >
                ...
                {(handleClick, open) => {
                  return (
                    <>
                      <button
                        type="button"
                        className={`block text-left w-full text-gray-800 dark:text-gray-100 truncate transition ${segments.includes('settings') ? '' : 'hover:text-gray-900 dark:hover:text-white'}`}
                        onClick={(e) => {
                          expandOnly ? setSidebarExpanded(true) : handleClick()
                        }}
                      >
                ...
                {(handleClick, open) => {
                  return (
                    <>
                      <button
                        type="button"
                        className={`block text-left w-full text-gray-800 dark:text-gray-100 truncate transition ${segments.includes('utility') ? '' : 'hover:text-gray-900 dark:hover:text-white'}`}
                        onClick={(e) => {
                          expandOnly ? setSidebarExpanded(true) : handleClick()
                        }}
                      >
                ...
                {(handleClick, open) => {
                  return (
                    <>
                      <button
                        type="button"
                        className={`block text-left w-full text-gray-800 dark:text-gray-100 truncate transition ${open ? '' : 'hover:text-gray-900 dark:hover:text-white'}`}
                        onClick={(e) => {
                          expandOnly ? setSidebarExpanded(true) : handleClick()
                        }}
                      >
                        <div className="flex items-center justify-between">
                          <div className="flex items-center">
                            <svg className="shrink-0 fill-current text-gray-400 dark:text-gray-500" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                              ...
                              <path d="M11.442 4.576a1 1 0 0 0-1.634-1.152L4.22 11.35 1.773 8.366A1 1 0 1 0 .227 9.634l1.5 1.5a1 1 0 0 0 1.46-.048l3.5-4ZM15.817 4.576a1 1 0 0 0-1.634-1.152l-5.609 7.957a1 1 0 0 0-1.347 1.453l.656.8a1 1 0 0 0 1.59-.058l6.344-9Z" />
                            </svg>
                            <span className="text-sm font-medium ml-4 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                              Authentication
                            </span>
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-center">
                            <svg className={`shrink-0 fill-current text-gray-400 dark:text-gray-500`} xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                              ...
                              <path d="M6.668.714a1 1 0 0 1 .793 1.171L6.997 4.5h3.464l.517-2.689a1 1 0 1 1 1.964.378L12.498 4.5h2.422a1 1 0 0 1 0 2h-2.807l-.77 4h2.117a1 1 0 1 1 0 2h-2.501l-.517 2.689a1 1 0 1 1-1.964-.378l.444-2.311H5.46l-.517 2.689a1 1 0 1 1-1.964-.378l.444-2.311H1a1 1 0 1 1 0-2h2.807l.77-4H2.46a1 1 0 0 1 0-2h2.5l.518-2.689a1 1 0 0 1 1.17-.793ZM9.307 10.5l.77-4H6.612l-.77 4h3.464Z" />
                            </svg>
                            <span className="text-sm font-medium ml-4 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                              Onboarding
                            </span>
                ...
                {(handleClick, open) => {
                  return (
                    <>
                      <button
                        type="button"
                        className={`block text-left w-full text-gray-800 dark:text-gray-100 truncate transition ${segments.includes('components-library') ? '' : 'hover:text-gray-900 dark:hover:text-white'}`}
                        onClick={(e) => {
                          expandOnly ? setSidebarExpanded(true) : handleClick()
                        }}
                      >
          ...
          <div className="w-12 pl-4 pr-3 py-2">
            <button className="text-gray-400 hover:text-gray-500 dark:text-gray-500 dark:hover:text-gray-400" onClick={() => setSidebarExpanded(!sidebarExpanded)}>
              ...
              <svg className="shrink-0 fill-current text-gray-400 dark:text-gray-500 sidebar-expanded:rotate-180" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                <title>展开/折叠箭头</title>
                <path d="M15 16a1 1 0 0 1-1-1V1a1 1 0 1 1 2 0v14a1 1 0 0 1-1 1ZM8.586 7H1a1 1 0 1 0 0 2h7.586l-2.793 2.793a1 1 0 1 0 1.414 1.414L12.498 8.511a.997.997 0 0 0 1.214-.214Z" />
              </svg>              
            </button>
          </div>
        </div>
